...
import App from 'components/static-page'
  ...
  return (
    <App title="Hacker News Security" isFooterVisible={false}>
      ...
      <p>
        ...
        <a href="mailto:security@ycombinator.com">security@ycombinator.com</a>.
      ...
      <ul>
        <li>
          ...
          determine valid user cookies and compromise accounts.
        </li>
      </ul>
      See{' '}
      ...
      <p>
        ...
        If you reported a vulnerability to us and don't see your name, please
